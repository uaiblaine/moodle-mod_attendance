...
$string['messagedselectedcountusersfailed'] = 'Failed to send a message to {$a} of the selected users.';
$string['messagedselecteduserfailed'] = 'Failed to send a message to {$a->fullname}.';
